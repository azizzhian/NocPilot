...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/report', name: 'report', component: () => import('@/views/ReportView.vue'), meta: { permission: 'report.view' } },
    ...
    { path: '/analytics', name: 'analytics', component: () => import('@/views/AnalyticsView.vue'), meta: { permission: 'analytics.view' } },
